...
type SysDept struct {
	...
	ParentId   uint       `json:"parentId" gorm:"column:parent_id;comment:'父id';NOT NULL"`                      // 父id
	DeptType   uint       `gorm:"column:dept_type;comment:'部门类型(1->公司, 2->中心，3->部门)';NOT NULL" json:"deptType"` // 部门类型(1->公司, 2->中心，3->部门)
	DeptName   string     `gorm:"column:dept_name;varchar(30);comment:'部门名 称';NOT NULL" json:"deptName"`        // 部门名称
